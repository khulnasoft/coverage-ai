...
def get_test_args(test_config: dict, pytest_config) -> argparse.Namespace:
    ...
    return argparse.Namespace(
        ...
        code_coverage_report_path=test_config.get(
            "code_coverage_report_path", "coverage.xml"
        ),
        model=pytest_config.getoption("--model") or test_config.get("model"),
        desired_coverage=test_config.get(
            "desired_coverage", SETTINGS.get("desired_coverage")
        ),
        max_iterations=test_config.get(
            "max_iterations", SETTINGS.get("max_iterations")
        ),
        max_run_time_sec=test_config.get(
            "max_run_time_sec", SETTINGS.get("max_run_time_sec")
        ),
        ...
        suppress_log_files=test_config.get(
            "suppress_log_files", pytest_config.getoption("--suppress-log-files")
        ),
    )
