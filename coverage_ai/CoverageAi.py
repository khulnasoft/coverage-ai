...
from coverage_ai.PromptBuilder import adapt_test_command_for_a_single_test_via_ai
...
class CoverageAi:
    def __init__(self, args):
        """
        Initialize the CoverageAi class with the provided arguments and run the test generation process.
    ...
    def run_test_gen(
        ...
        while iteration_count < self.args.max_iterations:
            ...
            if self.test_validator.get_current_coverage() >= (
