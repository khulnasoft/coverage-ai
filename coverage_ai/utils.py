...
from coverage_ai.lsp_logic.utils.utils import is_forbidden_directory
...
def parse_args_full_repo():
    ...
    parser.add_argument("--look-for-oldest-unchanged-test-file",
                        action="store_true", help="If set, Coverage-Ai will look for the oldest unchanged test file to analyze.")
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Number of times to run the tests generated by Coverage Ai. Default: %(default)s.",
    )
    parser.add_argument(
