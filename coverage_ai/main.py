...
def parse_args(settings: Dynaconf) -> argparse.Namespace:
    ...
    arg_definitions = [
        (
            "--source-file-path",
            dict(type=str, required=True, help="Path to the source file."),
        ),
        (
            "--test-file-path",
            dict(type=str, required=True, help="Path to the input test file."),
        ),
        (
            "--project-root",
            dict(type=str, default="", help="Path to the root of the project."),
        ),
        (
        ...
        (
            ...
            dict(
                type=str, required=True, help="Path to the code coverage report file."
            ),
        ),
        (
            "--test-command",
        ...
        (
            ...
            dict(action="store_true", help="Run each test separately."),
        ),
        (
            "--record-mode",
            dict(
