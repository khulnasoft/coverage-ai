...
from coverage_ai.report_generator import ReportGenerator
...
def dump_to_report(
    path_to_db="coverage_ai_unit_test_runs.db", report_filepath="test_results.html"
):
...
def dump_to_report_cli():
    ...
    parser.add_argument(
        "--path-to-db",
        type=str,
        default="coverage_ai_unit_test_runs.db",
