...
from coverage_ai.settings.config_schema import CoverAgentConfig, CoverageType
...
class TestCoverAgentConfig:
    ...
    @patch("coverage_ai.settings.config_schema.get_settings")
    ...
    @patch("coverage_ai.settings.config_schema.get_settings")
    def test_from_cli_args_with_defaults_empty_settings(
        self, mock_get_settings, sample_args
    ):
        """
