...
from coverage_ai.coverage_processor import CoverageProcessor
...
class TestCoverageProcessor:
    ...
    def test_returns_empty_lists_and_float(self, mocker):
        ...
        mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.extract_package_and_class_java",
            return_value=("com.example", "Example"),
        )
        mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.parse_missed_covered_lines_jacoco_xml",
            return_value=([], []),
        )
    ...
    def test_process_coverage_report(self, mocker):
        ...
        mock_verify = mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.verify_report_update"
        )
        mock_parse = mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.parse_coverage_report",
            return_value=([], [], 0.0),
        )
    ...
    def test_parse_missed_covered_lines_kotlin_jacoco_xml(self, mocker):
        ...
        """
        mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.extract_package_and_class_kotlin",
            return_value=("com.example", "Example"),
        )
    ...
    def test_parse_coverage_report_lcov_with_feature_flag(self, mocker):
        ...
        mock_parse_lcov = mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.parse_coverage_report_lcov",
            return_value=([], [], 0.0),
        )
        processor = CoverageProcessor(
    ...
    def test_parse_coverage_report_cobertura_with_feature_flag(self, mocker):
        ...
        mock_parse_cobertura = mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.parse_coverage_report_cobertura",
            return_value=([], [], 0.0),
        )
        processor = CoverageProcessor(
    ...
    def test_parse_coverage_report_jacoco(self, mocker):
        ...
        mock_parse_jacoco = mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.parse_coverage_report_jacoco",
            return_value=([], [], 0.0),
        )
        processor = CoverageProcessor(
    ...
    def test_parse_coverage_report_diff_cover_json(self, mocker):
        ...
        mock_parse_json = mocker.patch(
            "coverage_ai.coverage_processor.CoverageProcessor.parse_json_diff_coverage_report",
