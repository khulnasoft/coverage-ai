...
# auto-generated by coverage ai
    def test_try_fix_yaml_snippet_extraction(self):
        from coverage_ai.utils import try_fix_yaml
...
test_name:"""
    ...
    def test_parse_args_full_repo_defaults_with_imports(self):
        from coverage_ai.utils import parse_args_full_repo
        import sys
        import os
    ...
    def test_find_test_files(self, mocker):
        from coverage_ai.utils import find_test_files
        import argparse
        ...
        mocker.patch('coverage_ai.utils.is_forbidden_directory', return_value=False)
        mocker.patch('coverage_ai.utils.filename_to_lang', return_value='python')
    ...
    def test_find_test_files_with_forbidden_dirs(self, mocker):
        ...
        mocker.patch('os.walk', return_value=mock_os_walk)
        mocker.patch('coverage_ai.utils.is_forbidden_directory', side_effect=mock_is_forbidden)
        mocker.patch('coverage_ai.utils.filename_to_lang', return_value='python')
